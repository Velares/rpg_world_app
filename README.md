...
Version 0.8.18 is a local, single-player weird-fantasy starting-region generator
...
highlighting). The other editor categories are placeholders with clear "not
